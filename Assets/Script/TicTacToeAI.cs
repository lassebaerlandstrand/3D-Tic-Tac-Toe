...
public class TicTacToeAI : MonoBehaviour
{
    ...
    private void aiPlay(object sender, GlobalVar.turnClass e)
    {
        ...
        /*if(!GlobalVar.gameCompleted && e.turnIndicator == GlobalVar.turnIndex["AI"]) {
            ...
            placeInRandomPlace();
        }else */if(!GlobalVar.gameCompleted && e.turnIndicator % GlobalVar.turnIndex.Count == GlobalVar.turnIndex["AI"]) { // Minimax
    ...
    private int[] bestMove(BoxScript[,,] board)
    {
        ...
        //Debug.Log(a + " | " + maxScore);
        a = 0;
        //Debug.Log(indexMoves.Count);
        //return indexMoves[Random.Range(0, indexMoves.Count)];
        return indexMove;
